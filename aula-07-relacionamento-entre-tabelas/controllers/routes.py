...
import urllib # Permite ler as urls das APIs
import json # Faz a conversão de dados em formato JSON
...
def init_app(app):
    ...
    def gamesEstoque(id=None):
        ...
        if request.method == 'POST':
            ...
            return render_template('gamesestoque.html',
                                   gamesestoque=games_page,
                                   consoles=consoles)
    ...
    # Rota de catalogo de jogos (Consumoda API)
